...
if ( userName = readCookie ( "uName" ) ) {
	...
	var response = document.writeln("<h4 style=\"color: #fff;\">Hello " + userName + " welcome to Luvin ur Lashes<h4>");		
	//greeting.setAttribute(userName)	
} else {
...
function createCookie ( name, value, days ) {
	...
	if ( days ) {
		...
		var date = new Date();
		// All time is measured in miliseconds in javascripts
